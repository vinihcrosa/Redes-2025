...
📌 Por favor envie o texto do Capítulo 2 atual (ou a estrutura que você quer seguir), para que eu possa reescrevê-lo com:\\
	...
	•	referências acadêmicas usando \textbackslash{}cite\{\} puxando da sua refs.bib;\\
...
💡 Assim que você enviar o capítulo atual, posso produzir:\\
	...
	•	em ambiente \textbackslash{}section\{\} / \textbackslash{}subsection\{\} pronto para colar no seu LaTeX.\\
\\
...
o texto atual:\\
\\
\textbackslash{}section\{Evolução do Ransonware\}\\
\\
A evolução histórica do ransomware pode ser dividida em três fases principais:\\
\\
\textbackslash{}subsection\{Germinação (1989--2009)\}\\
\textbackslash{}begin\{itemize\}\\
    \textbackslash{}item Surgem os primeiros ransomwares com criptografia simples.\\
    \textbackslash{}item Propagação limitada, geralmente via engenharia social rudimentar.\\
    \textbackslash{}item Exemplos: AIDS Trojan, Gpcode.\\
\textbackslash{}end\{itemize\}\\
\\
\textbackslash{}subsection\{Ativação (2010--2016)\}\\
\textbackslash{}begin\{itemize\}\\
    \textbackslash{}item Uso de criptografia forte (AES, RSA).\\
    \textbackslash{}item Disseminação por botnets e anexos maliciosos.\\
    \textbackslash{}item Primeiros ransomwares para mobile e macOS.\\
    \textbackslash{}item Aparece o modelo Ransomware-as-a-Service (RaaS).\\
\textbackslash{}end\{itemize\}\\
\\
\textbackslash{}subsection\{Explosão (2017--presente)\}\\
\textbackslash{}begin\{itemize\}\\
    \textbackslash{}item Ataques globais baseados em exploração de vulnerabilidades (ex.: EternalBlue).\\
    \textbackslash{}item Adoção da dupla extorsão: criptografia + vazamento de dados.\\
    \textbackslash{}item Grupos criminosos altamente organizados.\\
    \textbackslash{}item Estratégia ``Big Game Hunting'': alvos de alto valor.\\
\textbackslash{}end\{itemize\}\\
\\
Segundo \textbackslash{}cite\{CEN2024110138\}, o ransomware atual combina criptografia intermitente, técnicas anti-detecção e operações orquestradas por equipes especializadas.\\
\end{tcolorbox}
