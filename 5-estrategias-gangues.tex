...
\subsection{Evolução Operacional Recente}
Dados de 2023--2025 indicam maior modularidade das campanhas: afiliados combinam \textit{loaders} genéricos com \textit{payloads} de ransomware sob medida, o que facilita troca rápida de ferramentas ao enfrentar defesas específicas \cite{SACCONE2025104264}. Vê-se também aumento de uso de criptografia intermitente para acelerar impacto e reduzir detecção baseada em I/O \cite{Begovic_2023}. Adoção crescente de APT-likes — semanas de reconhecimento antes do impacto — aproxima certas gangues de grupos de espionagem tradicionais, borrando fronteiras entre motivação financeira e estratégica \cite{enisa_2023}. Essas tendências reforçam a necessidade de inteligência contínua sobre TTPs e de controles que considerem dwell time prolongado, não apenas explosões rápidas de cifragem.
